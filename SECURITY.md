...
Colophon (shared core) is a WordPress FSE theme. We take security seriously — especially around PHP output escaping, file-path handling, and template safety.
...
1. **GitHub private security reporting** at https://github.com/thisismyurl/colophon/security/advisories/new
