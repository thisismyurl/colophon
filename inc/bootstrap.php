 ...
 *
 * This is the ONE place a theme's identity lives. Change the `colophon_` function
 * prefix and the COLOPHON_* constants and the entire theme re-prefixes, because
 ...
 * them honest.
 *
 * Why a `colophon_` function prefix and not a namespace (reversed 2026-07-20):
 ...
 * rewrites `colophon_` → `<slug>_`, `COLOPHON_` → `<SLUG>_`, and `Colophon_` →
 ...
 * stays a string LITERAL ('colophon'), never the COLOPHON_SLUG constant. `wp i18n
 ...
 */
define( 'COLOPHON_VERSION', '1.6266.1322' );
