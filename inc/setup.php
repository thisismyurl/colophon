...
function colophon_setup(): void {
	...
	// make-pot — see bootstrap.php); the path uses COLOPHON_DIR so it travels with a
	 ...
	 */
	$GLOBALS['content_width'] = (int) apply_filters( COLOPHON_SLUG . '/content_width', 720 );
	...
	register_nav_menus(
		(array) apply_filters(
			COLOPHON_SLUG . '/register_nav_menus',
			array(
