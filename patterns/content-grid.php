...
<section class="wp-block-group has-base-ground-background-color has-background" style="padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5)">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<h3 class="wp-block-heading has-serif-font-family" style="margin-top:var(--wp--preset--spacing--5);margin-bottom:var(--wp--preset--spacing--3)">First column heading</h3>
			<!-- /wp:heading -->
			...
			<p class="has-base-mid-color has-text-color" style="font-size:var(--wp--preset--font-size--sm)">A short summary of the topic, written to give the reader a clear sense of what waits behind the link.</p>
			<!-- /wp:paragraph -->
			...
			<p class="has-sans-font-family" style="font-size:var(--wp--preset--font-size--xs);font-style:normal;font-weight:600;letter-spacing:0.04em;text-transform:uppercase"><a href="#">Read more</a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"top":"var:preset|spacing|5","bottom":"var:preset|spacing|3"}}},"fontFamily":"serif"} -->
			<h3 class="wp-block-heading has-serif-font-family" style="margin-top:var(--wp--preset--spacing--5);margin-bottom:var(--wp--preset--spacing--3)">Second column heading</h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			...
			<!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"top":"var:preset|spacing|5","bottom":"var:preset|spacing|3"}}},"fontFamily":"serif"} -->
			<h3 class="wp-block-heading has-serif-font-family" style="margin-top:var(--wp--preset--spacing--5);margin-bottom:var(--wp--preset--spacing--3)">Third column heading</h3>
			<!-- /wp:heading -->
