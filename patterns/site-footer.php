...
<footer class="wp-block-group has-base-paper-color has-base-black-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--8);padding-left:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5)">
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column" style="flex-basis:40%">
			...
			<h2 class="wp-block-heading has-serif-font-family" style="margin-bottom:var(--wp--preset--spacing--3);font-size:var(--wp--preset--font-size--lg);font-weight:400">Site Name</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|sm","lineHeight":"1.6"},"color":{"text":"var:preset|color|base-rule"}}} -->
			<p class="has-base-rule-color has-text-color" style="font-size:var(--wp--preset--font-size--sm);line-height:1.6">A short tagline that says what this site is about in a single, plain sentence.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<h3 class="wp-block-heading has-base-mid-color has-text-color has-sans-font-family" style="margin-bottom:var(--wp--preset--spacing--4);font-size:var(--wp--preset--font-size--xs);font-weight:600;letter-spacing:0.08em;text-transform:uppercase">Explore</h3>
			<!-- /wp:heading -->
		...
		<div class="wp-block-column">
			<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"var:preset|font-size|xs","fontWeight":"600","letterSpacing":"0.08em","textTransform":"uppercase"},"spacing":{"margin":{"bottom":"var:preset|spacing|4"}},"color":{"text":"var:preset|color|base-mid"}},"fontFamily":"sans"} -->
			<h3 class="wp-block-heading has-base-mid-color has-text-color has-sans-font-family" style="margin-bottom:var(--wp--preset--spacing--4);font-size:var(--wp--preset--font-size--xs);font-weight:600;letter-spacing:0.08em;text-transform:uppercase">Contact</h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|sm","lineHeight":"1.8"},"color":{"text":"var:preset|color|base-rule"}}} -->
			<p class="has-base-rule-color has-text-color" style="font-size:var(--wp--preset--font-size--sm);line-height:1.8">hello@example.com<br>123 Example Street<br>City, Region</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	...
	<p class="has-base-mid-color has-text-color has-sans-font-family" style="font-size:var(--wp--preset--font-size--xs)">&copy; 2026 Site Name. All rights reserved.</p>
	<!-- /wp:paragraph -->
